    ...
    <header className="bg-tmdb-dark-blue text-white p-4 fixed w-full top-0 z-50"> {/* Updated background color */}
      <div className="container mx-auto flex items-center justify-between">
        ...
        <div className="flex items-center space-x-4">
          ...
          <button aria-label="Add to list" className="hidden md:block hover:text-tmdb-accent transition-colors duration-300 ease-in-out">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-6 h-6">
        ...
        <div className="md:hidden bg-tmdb-dark-blue/95 backdrop-blur-sm absolute top-full left-0 w-full pb-4"> {/* Added some styling for backdrop */}
          <nav className="flex flex-col items-center space-y-2 pt-2">
            ...
            <div className="flex space-x-4 pt-2">
                <button aria-label="Add to list" className="hover:text-tmdb-accent transition-colors duration-300 ease-in-out">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-6 h-6">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M12 4.5v15m7.5-7.5h-15" />
                    </svg>
                </button>
