...
export interface WishlistMovie {
  ...
  release_date: string;
  vote_average: number;
  overview?: string; // Added optional overview
  duration_minutes?: number; // Added optional duration_minutes
...
function isWishlistMovie(item: unknown): item is WishlistMovie {
  return typeof item === 'object' && item !== null &&
         typeof (item as WishlistMovie).id === 'number' && // Type assertion needed after unknown check
